...
try:
    ...
    def bill():
        ...
        if checkstatus1==True:
            ...
            print("PLEASE TRY AGAIN,STUDENT NAME DOES NOT EXIST IN SCHOOL DATABASE")    
        ...
        try:
            if ch1==1 and admin==1:
                ...
                while True:
                    ...
                    t3.add_row([5,"TO CHECK WHETHER A SPECIFC STUDENT IS PRESENT IN THE DATABASE OR NOT"])
                    ...
                    t3.add_row([8,"TO COLLECT THE TOTAL AMOUNT OF TRANSACTION THAT HAD TOOK PLACE IN A GIVEN DATE"])
